...
C     
C     Process: e+ e- > ta1- ta1+ WEIGHTED<=4 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
        IF(mdl_Wsl3.ne.0d0) fk_mdl_Wsl3 = SIGN(MAX(ABS(mdl_Wsl3),
     $    ABS(mdl_Msl3*small_width_treatment)), mdl_Wsl3)
      endif
      AMP(:,:) = (0d0,0d0)
      ...
      CALL FFV1P0_3(W(1,3),W(1,2),GC_3,ZERO,FK_ZERO,W(1,7))  !  count 1
      CALL FFV1P0_3(W(1,4),W(1,1),GC_3,ZERO,FK_ZERO,W(1,8))  !  count 1
      CALL VSS1P1N_1(W(1,6), W(1,5), GC_36, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_5_3(W(1,3),W(1,2),-GC_246,GC_250,MDL_MZ,FK_MDL_WZ,W(1,9)
     $)  !  count 1
      CALL FFV2_5_3(W(1,4),W(1,1),-GC_246,GC_250,MDL_MZ,FK_MDL_WZ,W(1,10
     $))  !  count 1
      CALL VSS1P1N_1(W(1,6), W(1,5), GC_311, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/9,10/),
